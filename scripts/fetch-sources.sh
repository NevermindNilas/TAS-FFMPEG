...
require_lock FFMPEG_VERSION FFMPEG_URL FFMPEG_SHA256 FFMPEG_COMMIT \
             ...
             WEBP_TAG WEBP_COMMIT WEBP_REPO \
             FREETYPE_TAG FREETYPE_COMMIT FREETYPE_REPO \
             HARFBUZZ_TAG HARFBUZZ_COMMIT HARFBUZZ_REPO \
             FRIBIDI_TAG FRIBIDI_COMMIT FRIBIDI_REPO \
             LIBASS_TAG LIBASS_COMMIT LIBASS_REPO \
             ...
             LAME_VERSION LAME_URL LAME_SHA256
